...
public abstract class OSMEntityTest {
    ...
    public void constructorAndHasAttribute() {
        ...
        assertTrue(testEntity.hasAttribute("testKey 1") && testEntity.hasAttribute("testKey 2")
    ...
    /**
     * Since the method build was not defined in OSMEntity, I used the reflection
     * for this test
     */
