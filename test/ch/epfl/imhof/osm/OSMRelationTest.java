...
public class OSMRelationTest extends OSMEntityTest {
    ...
    OSMEntity newEntity(long id, Attributes entityAttributes) {
        OSMRelation.Member testMember1 = new OSMRelation.Member(OSMRelation.Member.Type.NODE, "testPoint1",
                TEST_NODE_1);
    ...
    public void constructorWithNodeWayRelation() {
        OSMRelation.Member testMember1 = new OSMRelation.Member(OSMRelation.Member.Type.NODE, "testPoint1",
                TEST_NODE_1);
        OSMRelation.Member testMember2 = new OSMRelation.Member(OSMRelation.Member.Type.NODE, "testPoint2",
                TEST_NODE_2);
        ...
        OSMRelation.Member testMember4 = new OSMRelation.Member(OSMRelation.Member.Type.RELATION, "testRelation",
                relation);
        ...
        assertTrue(ch.epfl.imhof.testUtilities.ListNonMutableTestUtility.nonMutableFieldListTest(testMemberList,
                testEndRelation.members()));
    }
