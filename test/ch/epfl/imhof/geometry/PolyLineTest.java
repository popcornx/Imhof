...
public abstract class PolyLineTest {
    ...
    protected static List<Point> ptsUnitSquare = Arrays.asList(new Point(36, 54), new Point(36, 55), new Point(37, 55),
            new Point(37, 54));
    protected static List<Point> ptsUnitSquare2 = Arrays.asList(new Point(-11, -30), new Point(-10, -30),
            new Point(-10, -31), new Point(-11, -31));
    protected static List<Point> ptsRectangle = Arrays.asList(new Point(36, 54), new Point(36, 62), new Point(48, 62),
            new Point(48, 54));
    protected static List<Point> ptsRectangle2 = Arrays.asList(new Point(65, -80), new Point(65, -10),
            new Point(73, -10), new Point(73, -80));
    protected static List<Point> ptsPolygon = Arrays.asList(new Point(36, 62), new Point(31, 57), new Point(39, 57),
            new Point(41, 48), new Point(43, 57), new Point(43, 47), new Point(32, 46), new Point(38, 51),
            new Point(28, 57));
    protected static List<Point> ptsPolygon2 = Arrays.asList(new Point(0, 30), new Point(10, 20), new Point(11, 5),
            new Point(10, 29), new Point(15, 0), new Point(0, 47), new Point(2, 15));

    protected static List<List<Point>> pts = Arrays.asList(pts2, pts3, ptsSinglePoint, ptsSinglePoint2, ptsSinglePoint3,
            ptsTriangle, ptsTriangle2, ptsUnitSquare, ptsUnitSquare2, ptsRectangle, ptsRectangle2, ptsPolygon,
            ptsPolygon2);
